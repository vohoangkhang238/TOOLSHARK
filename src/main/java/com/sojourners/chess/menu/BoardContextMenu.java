...
public class BoardContextMenu extends ContextMenu {
    ...
    private BoardContextMenu() {
        /* BẮT ĐẦU ẨN các tính năng theo yêu cầu (bao gồm 编辑局面) */
        ...
        // Ẩn: 复制局面FEN & 粘贴局面FEN (đã ẩn từ trước)
        ...
        // Ẩn: 复制局面图片 & 粘贴局面图片 (đã ẩn từ trước)
